      ...
      <Modal.Body>
        <div className="popupbox-content">
          ...
          <div className="mt-3">
            ...
            <a  href={`https://github.com/mdmubasheer6544/${props.content.githubUrl}`}>
              <button type="button" className="btn btn-secondary btn-sm  ">
              <i className="fab fa-github"></i>
              </button>
            </a>
              <a className="githubLink " style={{paddingLeft:"25px"}}
                href={`https://mdmubasheer6544.github.io/${props.content.githubUrl}`}
              ><i className="fas fa-external-link-alt" style={{fontSize: "30px"}}></i></a>
            </div>    
          </div>
        </div>
      </Modal.Body>
